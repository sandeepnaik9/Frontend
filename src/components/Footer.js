...
const Footer = () => {
  return (
    <div className='container' style={{position:'relative',height:'250px',overflow:'hidden',marginTop:'200px',background:'linear-gradient(180deg, #FFFFFF 0%, #76ADFF 99.97%, rgba(191, 218, 247, 0) 99.98%)'}}>
